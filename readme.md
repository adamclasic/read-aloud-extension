...
## Installation
1. Download the [`read-aloud-extension-v1.1.0.zip`](https://github.com/adamclasic/read-aloud-extension/releases/download/v1.1.0/read-aloud-extension-v1.1.0.zip) file from the latest release.
